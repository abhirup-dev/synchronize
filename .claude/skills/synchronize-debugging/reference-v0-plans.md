...
| `docs/plans/ui-verification-agentic-pipeline.md` | 273 | Agentic UI verification pipeline for real-data Playwright probes, exact deterministic UI contract flows, adaptive capture, component glossary staleness, optional VibeProxy/Stagehand/Libretto/DevTools readiness checks, and later flow/state-graph layers (sync-rycd). |
