...
| `session-tracker/plan-session-annotation-architecture-v1.md` | 1974 | Future-proof session annotation architecture for pluggable host tools, long-running-agent workspace motivations, incremental append, overlays, on-demand cross-machine status, and FTS/Tantivy projections (sync-4v00, sync-t4ay). | Session annotation lake, host adapter interfaces, product motivations, incremental append, delayed bookmarks/tags, runtime derivation, federated annotation modes |
