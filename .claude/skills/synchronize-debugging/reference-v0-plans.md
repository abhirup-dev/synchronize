...
| `.claude/handoffs/2026-07-13-015130-sigil-ui-full-migration.md` | 326 | Multi-session handoff for replacing the legacy web presentation with the Sigil light/dark visual system while preserving production UX and responsive architecture; followed by `2026-07-13-024936-sigil-ui-full-migration-part-2.md` (sync-ewwp). |
| `.claude/handoffs/2026-07-13-024936-sigil-ui-full-migration-part-2.md` | ~300 | Part 2 of the Sigil migration handoff — continues `2026-07-13-015130-sigil-ui-full-migration.md` with accessibility fixes, conversation-shell tuning, legacy visual-system deletion, verification state, and supporting-surface review work (sync-ewwp); followed by `2026-07-13-093959-sigil-desktop-visual-delta-part-3.md`. |
| `.claude/handoffs/2026-07-13-093959-sigil-desktop-visual-delta-part-3.md` | 303 | Part 3 of the Sigil migration handoff — captures the non-headless Chrome production-data screenshot audit, all four desktop screenshot-agent reviews, calibrated remaining deltas, active preview processes, and the desktop-only read-only continuation scope (sync-ewwp); followed by `2026-07-13-103806-sigil-desktop-message-thread-activity-part-4.md`. |
| `.claude/handoffs/2026-07-13-103806-sigil-desktop-message-thread-activity-part-4.md` | 238 | Part 4 of the Sigil migration handoff — records the implemented desktop message grouping/self treatment, Thread context header and spacing, Activity control/row density, canonical harness-logo identity treatment across Chat/Activity/roster/header, fresh light/dark captures, full verification, and remaining Board/header/composer work (sync-ewwp); followed by `2026-07-13-114212-sigil-board-composer-polish-part-5.md`. |
| `.claude/handoffs/2026-07-13-114212-sigil-board-composer-polish-part-5.md` | 268 | Part 5 of the Sigil migration handoff — records compact desktop Board grammar with four-status preservation, Board rail/compact regressions and fixes, Composer density and Storybook shell alignment, grouped-message cascade repair, full verification, visible Chrome review state, explicit header/top-banner deferral, and remaining supporting-surface polish (sync-ewwp). |
...
| `.claude/handoffs/2026-07-18-parity-harness-fixtures-pipeline.md` | Parity harness v2 (`tools/parity/`) + design-fixtures pipeline: manifest-driven design-vs-impl pixel diffing, seed→fixtures export, designer own-world/extend data contract (`guidelines/parity-ready-bundle.md`), byte-faithful `pull-file.sh` (headless luna/terra/sonnet), designer round-2 verification results, last diff numbers. Forward work: bd `sync-vrc6`, `sync-6lir`, `sync-jraw`, `sync-7b1z`. |
